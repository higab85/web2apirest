...
//        String tamEquipoDeporte = request.getParameter("tamEquipoDeporte");
        ...
        try {            
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form action = '/CompeticionesRESTClienteWeb/logout' method = \"POST\">");
            ...
            out.println("<form action='/CompeticionesRESTClienteWeb/competiciones' method = \"POST\">");
                ...
                out.println("<input type = \"submit\" value = \"Mandar\" />");
            out.println("</form>");
            out.println("<h3>Cambiar nombre competicion</h3>");
            out.println("<form action='/CompeticionesRESTClienteWeb/changeCompeticion' method = \"POST\">");
                out.println("<div>Nombre nuevo: <input type = \"text\" name = 'nombre' /></div>");
                out.println("ID competicion: <input type = \"text\" name = \"id\" />");
                out.println("<input type = \"submit\" value = \"Mandar\" />");
            out.println("</form>");
            ...
            response.sendRedirect("/CompeticionesRESTClienteWeb/auth");
        }
